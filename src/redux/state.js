...
let state={
    ...
    onInputPostText(newPostText){
        this.profile.newPostText=newPostText;
    ...
    addPost(){
        let newPost={
            id:3,
            likeCount: 0,
            description: this.profile.newPostText,
            url: 'https://klike.net/uploads/posts/2019-05/1556777145_1.jpg'
        }
        this.profile.postsData.push(newPost);
    
        this.onInputPostText('')
    },
    // methods for addMessage on Messages Page
    onChangeMessageText(newMessageText){
        this.dialog.newMessageText=newMessageText;
    ...
    addMessage(){
        let newMessage={
            id:5,
            name: 'I',
            messageText: this.dialog.newMessageText,
            url: 'http://lorempixel.com/75/75',
            own: 1,
        }
        this.dialog.messagesData.push(newMessage);
